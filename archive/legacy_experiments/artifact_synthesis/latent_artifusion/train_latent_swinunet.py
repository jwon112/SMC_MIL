...
from model_training.scripts.improved_diffusion.swin_unet import SwinUNetModel
...
def log_validation(vae, unet, args, accelerator, epoch, scheduler):
...
def main():
    ...
    unet = SwinUNetModel(
        in_channels=4,
        model_channels=int(args.resolution/8),
        out_channels=4,
        sample_size=int(args.resolution / 8),
        dropout=0,
    ...
    if version.parse(accelerate.__version__) >= version.parse("0.16.0"):
        ...
        def load_model_hook(models, input_dir):
            ...
            for i in range(len(models)):
                ...
                load_model = SwinUNetModel.from_pretrained(input_dir, subfolder="unet")
