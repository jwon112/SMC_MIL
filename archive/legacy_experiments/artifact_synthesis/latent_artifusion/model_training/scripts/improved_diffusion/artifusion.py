...
# model = ArtiFusionModel(in_channels=3, img_size=256,out_channels=3,model_channels=128)
# # model.to(device)
# batch = 4
# input_x = torch.rand(batch,3,256,256)
# time = torch.rand(batch)

# print("input_x ",input_x.shape)
# print("time ",time.shape)

# # test_x = torch.rand(2,1,768)
# # print(test_x.repeat(2,1,1).shape)

# output = model(input_x,time)
