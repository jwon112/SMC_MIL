...
elif args.task == 'task_smc_future_significant_rejection':
    args.n_classes=2
    csv_path = args.csv_path if args.csv_path else 'dataset_csv/smc_future_significant_rejection.csv'
    dataset = Generic_MIL_Dataset(csv_path = csv_path,
                            data_dir= os.path.join(args.data_root_dir),
                            shuffle = False,
                            seed = args.seed,
